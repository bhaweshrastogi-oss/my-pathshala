...
const CFG = {
  ...
  courses: {
    basic: {
      ...
      price  : '₹25000',        
      amount : 25000,            
      // batch  : 'August 22, 2026 · Weekends 2 PM – 5 PM IST',  // commented out — restore when next batch date is set
    }
  },
...
const CURRICULUM = {
  ...
  ai: {
    ...
    weeks: [
      ...
      { t:'Designing AI Experiences & Prototyping', i:['AI Interaction Models','Copilot → Autopilot Spectrum','Designing for Trust','Designing AI Failure States','The AI PM Stack: A 7-Step Framework','Human-in-the-Loop Design','AI Prototyping'] },
      { t:'Prompting, RAG, Context Engineering & AI Architecture', i:['Prompt Engineering Fundamentals','From Prompt Engineering → Context Engineering','Embeddings & Semantic Search','RAG — Retrieval-Augmented Generation','RAG Failure Modes','Choosing the Architecture'] },
      { t:'AI Agents, Tool Use, MCP & Agentic Products',           i:['What Is an AI Agent?','The Agent Stack: Tools, Memory, Context, Orchestration','Agentic Loops & Self-Improving Systems','Single Agent vs Multi-Agent','Understanding MCP & AI Distribution','Agent Safety & Control'] },
      { t:'AI Evals, Metrics & Experimentation', i:['Why Traditional QA Breaks for AI','Building Eval Datasets','Eval Methods','Evaluating Agents','Offline vs Online Evals','Product Metrics for AI'] },
      { t:'AI Economics, Growth & Production Operations', i:['AI Unit Economics','The Right Economic Metric','Quality × Cost Trade-off','Cost Optimisation','AI Product Growth','AI Feedback Loops','Production Observability'] },
      { t:'Responsible AI, Security, Enterprise Readiness & Capstone', i:['Responsible AI','AI Privacy & Data','AI Security','Agentic Risk','AI Governance','Enterprise AI Readiness','AI Launch Strategy','AI Product Review Board / Capstone'] },
    ]
  }
};
